class Preference < ActiveRecord::Base
  ...
  ALL_KEYS = [
    TRY_MAX, WEB_ADMIN_PASSWORD, PATH_TO_SERVER, COMMAND_SCHEME, MOTD,
    RULES_JSON, TUTORIAL_JSON, FAQ_JSON, DONATIONS_JSON,
    ...
    IRC_NICKSERV_PASSWORD, ORIGIN_SALT, DB_IP_API_KEY, MMP_API_KEY,
    SLACK_API_KEY, SLACK_GROUP, BEECHAT_GROUP, IS_JUNK_OBJECTIVE_TIMESTAMP,
    ACTIVE_IN_IRC, LATEST_GAMETICK, LATEST_GAMETICK_POPULATION,
    LATEST_GAMETICK_TIMESTAMP, LATEST_GAMETICK_IN_PROGRESS, STOP_WORDS
  ]
  ...
  SYSTEM_KEYS = [
    ...
    LATEST_GAMETICK_IN_PROGRESS, STOP_WORDS
  ]

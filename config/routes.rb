...
Rails.application.routes.draw do
  ...
  resources :player_images, only: :show
  get 'player_images/:id/:size.:format' => 'player_images#show', as: :player_images
  ...
  namespace :admin do
    ...
    resources :donations, as: :message_donations, controller: :donations

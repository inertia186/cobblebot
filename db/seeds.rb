...
ServerCallback::ServerEntry.send method, name: 'Predict', pattern: "/^com\.mojang\.authlib\.GameProfile@[^ ]+\\\[id=<null>,name=(.*),properties={},legacy=false\\\] \\\(\\/[0-9\.]+:[0-9]+\\\) lost connection: Disconnected$/", command: "emote_player_prediction(\"@a\", \"%1%\")", system: 'f'

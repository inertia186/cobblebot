...
ServerCallback::PlayerChat.send method, name: 'lmgtfy', pattern: "/@server lmgtfy (.+)/i", command: "say_lmgtfy_link \"@a\", \"%1%\"", help_doc_key: 'lmgtfy', help_doc: "Usage: @server lmgtfy <query>", system: 't'
...
ServerCallback::PlayerChat.send method, name: 'Reply Tip', pattern: "/^@server replytip (.*)/i", command: "add_tip \"%nick%\", \"%1%\", reply: true", help_doc_key: 'replytip', help_doc: "Usage: @server replytip [tip]\n\nAdds a useless tip in reply to the last useless tip.", system: 't'
...
ServerCallback::PlayerChat.send method, name: 'Tip Info', pattern: "/^@server tips(.*)/i", command: "tips(\"@a\", \"%1%\")", help_doc_key: 'tips', help_doc: "Usage: @server tips\n\nSome statistics about the random tips memory bank.", system: 't'
...
ServerCallback::PlayerChat.send method, name: 'FAQ', pattern: "/^@server faq/i", command: "say_faq \"%nick%\"", help_doc_key: 'faq', help_doc: "Usage: @server faq", system: 't'
...
ServerCallback::PlayerChat.send method, name: 'Read Mail', pattern: "/^@server mail(.*)/i", command: "tell_mail(\"%nick%\", \"%1%\")", help_doc_key: 'mail', help_doc: "Usage: @server mail\n\nRead latest mail.\nUsage: @server mail clear\n\nRemoves mail from your inbox.\nUsage: @server mail mute <player>\n\nIgnore all mail from a player.\nUsage: @server mail unmute <player>\n\nStop ignoring all mail from a player.\nTo send mail to a player, type: @player <message>", system: 't'
ServerCallback::ServerEntry.send method, name: 'Current Topic', pattern: "/([a-z0-9_]+) joined the game/i", command: "tell_topic \"%1%\"", system: 't'
ServerCallback::PlayerChat.send method, name: 'Topic', pattern: "/^@server topic$/i", command: "tell_topic(\"%nick%\")", help_doc_key: 'topic', help_doc: "Usage: @server topic\n\nShow the current topic.  To set the topic:\n@server topic <new topic>", system: 't'
ServerCallback::PlayerChat.send method, name: 'Set Topic', pattern: "/^@server topic (.*)/i", command: "set_topic(\"%nick%\", \"%1%\")", system: 't'
...
ServerCallback::PlayerChat.send method, name: 'Rate', pattern: "/^@server rate ([a-zA-Z0-9_]+) ([\\-0-9]+)/i", command: "rate(\"%nick%\", \"%1%\", \"%2%\")", help_doc_key: 'rate', help_doc: "Usage: @server rate <nick> <rating>\n\nAdds an entry to the web of trust.", system: 't'
ServerCallback::PlayerChat.send method, name: 'Vote Kick', pattern: "/^@server votekick ([a-zA-Z0-9_]+)/i", command: "votekick(\"%nick%\", \"%1%\")", help_doc_key: 'votekick', help_doc: "Usage: @server votekick <nick>\n\nRegisters a vote to kick a player.", system: 't'
ServerCallback::PlayerChat.send method, name: 'Get Trust', pattern: "/^@server gettrust ([a-zA-Z0-9_]+)[ ]*([a-zA-Z0-9_]*)/i", command: "truster = \"%1%\"\ntrustee = \"%2%\"\ntrustee = truster and truster = \"%nick%\" if trustee.empty?\nsay_trust('@a', truster, trustee)", help_doc_key: 'gettrust', help_doc: "Usage: @server gettrust <player> [other player]\n\nSee the sum of trust between two players. See: @server help rate", system: 't'
ServerCallback::PlayerChat.send method, name: 'Gametick', pattern: "/^@server gametick$/i", command: "Thread.start do\n  say_gametick('@a')\nend", help_doc_key: 'gametick', help_doc: "Usage: @server gametick\n\nReports the current game tick and average.", system: 't'
...
# Miscellaneous
ServerCallback::PlayerChat.send method, name: 'Donations', pattern: "/^@server (donations|donate)/i", command: "tell_donations(\"%nick%\")", help_doc_key: 'donations', help_doc: "Usage: @server donations\n\nShows donation information.", system: 't'

...
ServerCallback::ServerEntry.send method, name: 'Player Authenticated', pattern: "/UUID of player ([a-zA-Z0-9_]+) is ([a-fA-Z0-9-]+)/", command: "check_mail(\"%1%\")\nirc_event \"%1% joined the game\"\nplayer_authenticated \"%1%\", \"%2%\"\ndetect_trouble_entities\ndetect_frozen_projectiles", system: 't'
...
ServerCallback::ServerEntry.send method, name: 'Latest Player IP', pattern: "/([a-zA-Z0-9_]+)\\[\\/([0-9\.]+):.+\\] logged in with entity [0-9]+ id at \(([\-0-9]+\.[0-9]+), ([\-0-9]+\.[0-9]+), ([\-0-9]+\.[0-9]+)\)/", command: "update_player_last_ip \"%1%\", \"%2%\"\nupdate_player_last_location(\"%1%\", \"%3%\", \"%4%\", \"%5%\")", system: 't'

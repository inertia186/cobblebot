...
ServerCallback::PlayerChat.send method, name: 'Read Mail', pattern: "/^@server mail/i", command: "tell_mail(\"%nick%\")", help_doc_key: 'mail', help_doc: "Usage: @server mail\nRead latest mail.  To send mail to a player, type: @player <message>", system: 't'
